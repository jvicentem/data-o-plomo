...
for (i in 1:200) {
  ...
  if (yes_yes > 0.75 & norm_yes > 0.5) {
    results[i, 2] <- 1
  } else {
    if (no_no > 0.6 & norm_no > 0.65) { #Puede ser interesante poner el norm_no a 0.6, incluso, además de eso, poner no_no a 0.5
      results[i, 2] <- 0
...
results_testing <- data.frame(1:nrow(testing), 1)
