...
for (i in 1:200) {
  ...
  # 26 no, 174 si, 0.725 accuracy kaggle
  # 17 no, 183 si, 0.7404 accuracy kaggle poniendo el norm_yes > 0.4
  # votes <- c(0,0,0)
  # 
  # if (no_yes > 0.4) {
  #   votes[1] <- 1
  ...
  #Con media: 11 no 189 si, 0.748 de accuracy kaggle -> En el private da 0.81
  mean_yes <- weighted.mean(c(no_yes, yes_yes, norm_yes), c(0.2,0.4,0.5))
  mean_no <- weighted.mean(c(no_no, yes_no, norm_no), c(0.45,0,0.55))
  if (mean_no > 0.65) {
    results[i, 2] <- 0
  } else {
    results[i, 2] <- 1
  ...
  # Jugando con las probabilidades es muy a favor de los sí. 9 no, 191 si, 0.76336 de accuracy kaggle
